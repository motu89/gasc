        ...
        <div className="p-3 sm:p-6">
          <div className="mb-2 sm:mb-4 flex items-start justify-between gap-1">
            <div className="min-w-0">
              <h3 className="mb-0.5 sm:mb-1 text-sm sm:text-xl font-semibold text-gray-800 transition group-hover:text-primary-600 line-clamp-1">
                {service.title}
              </h3>
          ...
          <p className="mb-2 sm:mb-4 line-clamp-2 text-xs sm:text-sm text-gray-600 hidden sm:block">{service.description}</p>
          <div className="mb-2 sm:mb-4 flex items-center text-xs sm:text-sm text-gray-500">
          ...
          <div className="flex items-center justify-between border-t pt-2 sm:pt-4">
            <div>
              <p className="text-base sm:text-2xl font-bold text-primary-600">{formatCurrency(service.hourlyRate)}</p>
